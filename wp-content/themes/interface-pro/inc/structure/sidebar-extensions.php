...
add_action( 'interface_testimonial_page_sidebar', 'interface_display_testimonial_page_sidebar', 10 );
/**
 * Show widgets on Testimonial Page Template's sidebar.
 *
 * Shows all the widgets that are dragged and dropped on the Testimonial Page Sidebar.
 */
function interface_display_testimonial_page_sidebar() {
	// Calling the conatact page sidebar
	if ( is_active_sidebar( 'interface_testimonial_page_our_client_sidebar' ) ) :
	dynamic_sidebar( 'interface_testimonial_page_our_client_sidebar' );
	endif;
}

/****************************************************************************************/

add_action( 'interface_services_page_sidebar', 'interface_display_services_page_sidebar', 10 );
/**
 * Show widgets on Services Page Template's sidebar.
 *
 * Shows all the widgets that are dragged and dropped on the Services Page Sidebar.
 */
function interface_display_services_page_sidebar() {

	// Calling the services page sidebar
	if ( is_active_sidebar( 'interface_services_page_section' ) ) :
	dynamic_sidebar( 'interface_services_page_section' );
	endif;
}

/****************************************************************************************/

add_action( 'interface_ourteam_page_sidebar', 'interface_display_ourteam_page_sidebar', 10 );
/**
 * Show widgets on Ourteam Page Template's sidebar.
 *
 * Shows all the widgets that are dragged and dropped on the Ourteam Page Sidebar.
 */
function interface_display_ourteam_page_sidebar() {
	// Calling the Ourteam page sidebar
	if ( is_active_sidebar( 'interface_ourteam_page_section' ) ) :
	dynamic_sidebar( 'interface_ourteam_page_section' );
	endif;
}
