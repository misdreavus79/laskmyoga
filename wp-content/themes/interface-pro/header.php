...
<?php
	...
	?>
	  <?php  if( is_page_template( 'page-templates/page-template-gallery-four-column.php') ||  is_page_template( 'page-templates/page-template-gallery-three-column.php')  ||  is_page_template( 'page-templates/page-template-gallery-two-column.php') ) { ?>
